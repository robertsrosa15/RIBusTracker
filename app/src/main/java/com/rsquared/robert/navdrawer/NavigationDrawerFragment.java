...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] arrayList = bundle.getStringArray("ArrayBusTitle");
        String[] arrayTitle = getActivity().getIntent().getExtras().getStringArray("ArrayBusTitle");

//        String[] arrayTitle = getActivity().getIntent().getExtras().getStringArray("ArrayBusTitle");
            mDrawerListView.setAdapter(new ArrayAdapter<String>(
                    getActionBar().getThemedContext(),
                    android.R.layout.simple_list_item_activated_1,
                    android.R.id.text1, arrayTitle
                ));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.track_bus) {
//            startActivity(new Intent(this.getActivity(), MapsActivity.class));
            String url = this.getActivity().getIntent().getExtras().getString(getString(R.string.url));
//            Bundle bundle = new Bundle();
//            bundle.putString(getString(R.string.url), url);
//            Intent intent = new Intent(this.getActivity(), MapParser.class).putExtras(bundle);

            setMapInfo(url);

//            startActivity(intent);
            Toast.makeText(getActivity(), "Start Map Activity.", Toast.LENGTH_SHORT).show();
            return true;
        }
